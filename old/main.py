...
conn_string_file		= open("./private_data/mongo_connection_string.txt", "r")

client_id               = int(client_id_file.read())
server_id               = int(server_id_file.read())
mongo_connection_string = conn_string_file.read()
...
mongo_currency = currency_mongo.Currency(mongo_connection_string)
