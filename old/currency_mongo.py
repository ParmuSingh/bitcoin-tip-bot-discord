...
class Currency:
		def __init__(self, conn_string):
				#self.client = MongoClient("mongodb://btc-discord-bot-user:samsunggalaxys@localhost:27017/")
		...
		def send_money(self, sender_id, receiver_id, amount):
				...
				# transfer_result_example = {
				#       'wtx_transfer_in': {
				#               'id': 'wtx_2IleWysigw3VxUM6CpRdwvL',
				#               'created_at': 1611479510, 'num_satoshis': 20, 'user_label': 'internal discord bot transfer', 'wal': {'id': 'wal_ns7XaMsJO6FQI', 'created_at': 1611477965, 'updated_at': 1611479510, 'user_label': 'discord-bot-user-411498939041185794', 'balance': 20, 'statusType': {'type': 'wallet', 'name': 'active', 'display_name': 'Active'}}, 'wtxType': {'layer': 'ln', 'name': 'ln_transfer_in', 'display_name': 'Transfer In'}, 'lnTx': None, 'passThru': {'lnPayParams': None, 'dest_wallet_id': 'wal_ns7XaMsJO6FQI', 'source_wallet_id': 'wal_gC47E2xGyXclhj'}}, 'wtx_transfer_out': {'id': 'wtx_KReZgATixJHqCnSC95SAvY', 'created_at': 1611479509, 'num_satoshis': -20, 'user_label': 'internal discord bot transfer', 'wal': {'id': 'wal_gC47E2xGyXclhj', 'created_at': 1611474292, 'updated_at': 1611479509, 'user_label': 'discord-bot-user-331840338748506114', 'balance': 80, 'statusType': {'type': 'wallet', 'name': 'active', 'display_name': 'Active'}}, 'wtxType': {'layer': 'ln', 'name': 'ln_transfer_out', 'display_name': 'Transfer Out'}, 'lnTx': None, 'passThru': {'lnPayParams': None, 'dest_wallet_id': 'wal_ns7XaMsJO6FQI', 'source_wallet_id': 'wal_gC47E2xGyXclhj'}}}
